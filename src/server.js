...
function buildSystemPrompt(context) {
  ...
  return [
    ...
    '5. Once you are reasonably confident which listed service matches (and nothing in the owner guidelines rules it out), stop asking questions. Tell them: the likely job type in plain language, the typical on-site duration, and the price (state it\'s an estimate and confirmed on inspection unless the service is fixed price). If you learned it\'s a laptop vs desktop and that pushes the job toward the harder/easier end, say so and lean your quoted estimate toward the appropriate end of the listed range rather than always quoting the midpoint. Then invite them to book.',
    '6. If after a few exchanges nothing on the list plausibly matches, the issue sounds outside what\'s listed, or the owner guidelines rule it out, say so honestly and that you\'ll pass it to the team — do not force-fit a service that doesn\'t belong.',
    '',
    'Rules:',
