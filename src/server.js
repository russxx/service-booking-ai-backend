...
function buildSystemPrompt(context) {
  ...
  return [
    ...
    '3. Once you are reasonably confident which listed service matches, stop asking questions. Tell them: the likely job type in plain language, the typical on-site duration, and the price (state it\'s an estimate and confirmed on inspection unless the service is fixed price). Then invite them to book.',
    '4. If after a few exchanges nothing on the list plausibly matches, or the issue sounds outside what\'s listed, say so honestly and that you\'ll pass it to the team — do not force-fit a service that doesn\'t belong.',
    '',
    'Rules:',
    ...
    '- Never invent a price, duration, or capability not listed above.',
